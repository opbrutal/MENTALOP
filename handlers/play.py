...
async def play(_, message: Message):
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                try:
                    ...
                    await lel.edit("<b>𝘼𝙙𝙙 𝙈𝙚 𝘼𝙨 𝘼𝙙𝙢𝙞𝙣 𝙁𝙞𝙧𝙨𝙩 𝙎𝙩𝙪𝙥𝙞𝙙.</b>")
                    return
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/94255afc2d0148e1de31c.jpg"
        ...
        try:
            ...
            await lel.edit("𝙎𝙤𝙧𝙧𝙮 𝙎𝙤𝙣𝙜 𝙉𝙤𝙩 𝙁𝙤𝙪𝙣𝙙 ☹ ️𝙏𝙧𝙮 𝘼𝙜𝙖𝙞𝙣...")
            print(str(e))
            return
